...
class WalkTest(unittest.TestCase):
    def test_the_walk_visits_every_base_and_every_pointer(self):
    ...
    def test_it_exercises_every_window_address(self):
        steps = exhaustive.walk()
    ...
    def test_it_ends_by_comparing_the_whole_memory(self):
        self.assertEqual(exhaustive.walk()[-1][0], "dump")

    def test_the_reset_walk_leaves_state_behind_before_resetting(self):
...
class ComparisonTest(unittest.TestCase):
    ...
    def test_a_transcript_that_stops_early_is_reported(self):
        self.assertEqual(exhaustive.differences(["AA", "BB"], ["AA"])[0][0], 1)


class OptionTest(unittest.TestCase):
    def test_the_default_driver_is_enough(self):
        self.assertEqual(exhaustive.options([]).driver, exhaustive.DEFAULT_DRIVER)

    def test_the_driver_can_be_pointed_elsewhere(self):
...
class AgainstReferenceTest(unittest.TestCase):
    def test_the_model_agrees_with_the_reference_in_every_state(self):
        steps = exhaustive.walk()
    ...
    def test_and_on_what_a_reset_leaves_behind(self):
        steps = exhaustive.resetting()
