...
**7** addresses · **256** states, all of them visited · **3,126** steps compared against the reference, **0** disagreements · **395** tests · **100%** statement and branch coverage · no dependencies
